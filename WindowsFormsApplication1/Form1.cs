         ...
         /*   List<string> liness = new List<string>();
           ...
           */
            ...
            for (int index = 0; index < lines.Count(); index++)
            {
                ...
                if (!firstFound && lines[index].Contains("yahoo.com") || lines[index].Contains("aol.com") || lines[index].Contains("outlook.com") || lines[index].Contains("gmail.com") || lines[index].Contains("hotmail.com"))
                {
                    // MessageBox.Show("true");
                    //MessageBox.Show(lines[index]);
                    comboBox1.Items.Add(lines[index]);
...
";
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
...

            {
                ...
                {
                    writer.WriteLine(richTextBox6.Lines[n]);
                }
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                using (var client = new MailKit.Net.Imap.ImapClient())
                {
                    ...
                    if (comboBox3.Text.Contains("From"))
                    {
                        ...
                        for (int i = 0; i < inbox.Count; i++)
                        {
                            ...
                            string textfrom = inbox.GetMessage(i).From.ToString();



                            richTextBox6.Text += textfrom + "\n";
                    ...
                    // get ip from source
                    if (comboBox3.Text.Contains("Sender ip"))
                    {
                        if (comboBox1.Text.Contains("gmail.com"))
                        {
                            client.Connect("imap.gmail.com", 993, true);
                        ...
                        if (comboBox1.Text.Contains("hotmail.com"))
                        {
                            ...
                            for (int i = 0; i < inbox.Count; i++)
                            {
                                ...
                                var uids = inbox.Search(SearchQuery.NotSeen);
                                string text = inbox.GetMessage(i).ToString();
                                ...
                                /*string[] content3 = Regex.Split(content1, @"\W");
                                 ...
                                 var matches = Regex.Matches(text, @"(\d{0,9}\.\d{0,9}\.\d{0,9}\.\d{0,9})");
                               
                                Regex regex = new Regex(@"[A-Za-z]+Story[0-9]*");
                             
                                richTextBox6.Text += matches[3].ToString() + "\n";
                        ...
                        else
                        {
                            while ((inbox.Count) > 0)
                            {
                                /* var matchFolder = client.GetFolder("inbox");
                                 spam.MoveTo(iz, matchFolder);*/
                                // code moving from spam to archive
                                var archive = client.GetFolder("Archivage");
                                //  MessageBox.Show(archive.Count.ToString());
                                var matchFolder = client.GetFolder("inbox");
                        ...
                        else
                        {
                            while ((inbox.Count) > 0)
                            {
                                /* var matchFolder = client.GetFolder("inbox");
                                 spam.MoveTo(iz, matchFolder);*/
                                // code moving from spam to archive
                               // code for geting name of folders
                                /* MessageBox.Show("");
                                var personal = client.GetFolder(client.PersonalNamespaces[0]);
    ...
    new System.IO.StreamReader(path);
       ...
       public static string path="";
                ...
                using (var client = new MailKit.Net.Imap.ImapClient())
                {
                    ...
                    if (comboBox3.Text.Contains("From"))
                    {
                        ...
                        if (comboBox1.Text.Contains("hotmail.com"))
                        {
                            ...
                            var inbox = client.GetFolder("junk");
                            label8.Text = inbox.Count.ToString();
                            inbox.Open(FolderAccess.ReadOnly);
        ...
        private void button19_Click_1(object sender, EventArgs e)
        {
          ...
          /*  if ((String.IsNullOrEmpty(textBoxR.Text))  || (String.IsNullOrEmpty(textBoxB.Text)) || (String.IsNullOrEmpty(textBoxG.Text)) || (String.IsNullOrEmpty(textBoxA.Text)))
            {
                MessageBox.Show("Please Chose a Color !");
            }*/
            ...
            String range = "Your Servers!B1:B";
            ...
            // test show text name server to start
